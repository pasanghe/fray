...
import objectclasses.MinionCard;
	 ...
	 *
	 */
public class Calvary extends MinionCard {
		
		private ImageIcon image;
		private String cardName = "Calvary";
		private int cardAttackPoints = 2;
		...
		public String toString() {
			return "Calvary [image=" + image + ", cardName=" + cardName + ", cardAttackPoints=" + cardAttackPoints
