 ...
 *
 */
public class Swordsman extends MinionCard {
	
	private ImageIcon image;
	private String cardName = "Swordsman";
	private int cardAttackPoints = 1;
	private int cardHealthPoints = 2;
	...
	public String toString() {
		return "Swordsman [image=" + image + ", cardName=" + cardName + ", cardAttackPoints=" + cardAttackPoints
